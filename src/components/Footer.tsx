        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/services/dubai" className="text-primary-foreground/80 hover:text-accent transition-colors">{t('nav.services')}</Link></li>
              <li><Link to="/knowledge/news" className="text-primary-foreground/80 hover:text-accent transition-colors">{t('nav.knowledge')}</Link></li>
              <li><Link to="/about" className="text-primary-foreground/80 hover:text-accent transition-colors">{t('nav.about')}</Link></li>
              <li><Link to="/careers" className="text-primary-foreground/80 hover:text-accent transition-colors">{t('nav.careers')}</Link></li>
              <li><Link to="/store" className="text-primary-foreground/80 hover:text-accent transition-colors">{t('nav.store')}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span className="text-primary-foreground/80">{t('services.dubai')}</span>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="h-4 w-4 mt-0.5 text-accent flex-shrink-0" />
                <span className="text-primary-foreground/80">{t('services.sharjah')}</span>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="h-4 w-4 mt-0.5 text-accent flex-shrink-0" />
                <span className="text-primary-foreground/80">{t('services.egypt')}</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-primary-foreground/80">{t('contact.hours')}</span>
              </li>
            </ul>
          </div>
        </div>
