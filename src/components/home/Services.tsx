    ...
    <section className="py-24 bg-gradient-subtle">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4">Our Legal Services</h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Comprehensive legal solutions across multiple jurisdictions
          </p>
        </div>
        ...
        {/* Office Locations */}
        <div className="mt-20">
          <h3 className="text-3xl font-serif font-bold text-center mb-12">Services by Location</h3>
              ...
              <Link key={index} to={office.link}>
                <Card className="h-full border-border/50 hover:border-accent transition-all duration-300 hover:shadow-gold group cursor-pointer">
                  <CardContent className="p-8 text-center">
                    <h4 className="text-2xl font-serif font-bold mb-3 group-hover:text-accent transition-colors">{office.name}</h4>
